export const en = {
  ...
  hero: {
    ...
    description: "Full Stack Developer specializing in Laravel, React.js, Next.js, and Tailwind CSS. Experienced in building enterprise web applications (HRIS, CRM, ERP), RESTful APIs, system integrations, and scalable relational databases. Passionate about developing efficient, user-friendly applications with a strong foundation in backend development and UI/UX design.",
